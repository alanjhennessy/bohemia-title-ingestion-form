...
export const ALBUM_FIELDS: FieldConfig[] = [
  ...
  { id: "cLineYear", label: "C-Line Year", type: "text", placeholder: "YYYY" },
  { id: "cLineName", label: "C-Line Name", type: "text", colSpan: 2 },
  { id: "pLineYear", label: "P-Line Year", type: "text", placeholder: "YYYY" },
  { id: "pLineName", label: "P-Line Name", type: "text", colSpan: 2 },
  { id: "parentalAdvisory", label: "Parental Advisory", type: "text" },
  { id: "recordingYear", label: "Recording Year", type: "text", placeholder: "YYYY" },
...
export const TRACK_FIELDS: FieldConfig[] = [
  ...
  { id: "trackRecordingYear", label: "Track Recording Year", type: "text", placeholder: "YYYY" },
