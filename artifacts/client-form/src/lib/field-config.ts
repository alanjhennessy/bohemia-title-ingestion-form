...
export const ALBUM_FIELD_GROUPS: FieldGroup[] = [
  {
  ...
  },
  {
    title: "Genre",
    fields: [
      { id: "mainGenre", label: "Main Genre", type: "select", placeholder: "Select a genre…", options: GENRE_OPTIONS },
...
export const TRACK_FIELD_GROUPS: FieldGroup[] = [
  {
  ...
  },
  {
    ...
    fields: [
      { id: "trackMainGenre", label: "Track Main Genre", type: "select", placeholder: "Select a genre…", options: GENRE_OPTIONS },
...
export const ALBUM_FIELDS: FieldConfig[] = ALBUM_FIELD_GROUPS.flatMap((g) => g.fields);
export const TRACK_FIELDS: FieldConfig[] = TRACK_FIELD_GROUPS.flatMap((g) => g.fields);
